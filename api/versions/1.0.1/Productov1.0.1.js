...
export const getProductoV101 = async ( req,res)=>{
    try {
...
export const postProductoV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putProductoV101 = async (req,res)=>{
...
export const deleteProductoV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
